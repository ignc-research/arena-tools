...
class MapGenerator(QtWidgets.QMainWindow):
    ...
    def setup_ui(self):
        ...
        frame.layout().addWidget(height_label, layout_index, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
        ## spinbox
        ...
        frame.layout().addWidget(type_label, layout_index, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
        ## dropdown
        ...
        frame.layout().addWidget(self.corridor_width_label, layout_index, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
        ## spinbox
        ...
        frame.layout().addWidget(self.iterations_label, layout_index, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
        ## spinbox
        ...
        frame.layout().addWidget(self.obstacles_label, layout_index, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
        ## spinbox
        ...
        frame.layout().addWidget(number_of_maps_label, layout_index, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
        ## spinbox
